...
proc sql;
connect to oracle (path=dwp1rac dbprompt=NO defer=NO user=tibbettsn password=Tttttt222222);

*TO BE UPDATED;
%LET STRTDT = FEB 2019;
%LET ENDDT  = MAY 2019;
%LET TF = FEB2019_MAY2019;
...
outfile="W:\APPLICATION ANALYSIS\MCO and MBHP Evaluation Scorecard\&TF.\REPORTS\MCO_MBH_SCORECARD_&TF..XLS"
		      replace;			
sheet="&SYSDATE";
run;
