...
and metadata_date_created between TO_DATE('20200901','yyyymmdd') and TO_DATE('20210225','yyyymmdd') --rolling history of 6months /*UPDATE*/
)
...
SELECT query_month,month_service,plan,aco,benchmark_name,measure,claim_count,actual/100 as pct
from
(
select rpt.*,
...
from MCO_MBH_REPORT_jun2020_sep2020 rpt  /*UPDATE*/
where measure in(
'PCT_ADMITDT',
'PCT_DIAG_ADMIT',
'PCT_AMTALLOW',
